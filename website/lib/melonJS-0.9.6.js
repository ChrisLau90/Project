...
(function($) {
	 ...
	 * HUD.js information, current viewport, collision map, etc..<br>
	...
	me.game = (function() {
		...
		api.viewport = null;
		/**
		 * a reference to the game HUD.js (if defined).
		 * @public
		 * @type me.HUD_Object
		 * @name me.game#HUD.js
		 */
		 ...
		 * destroy all current object except the HUD.js
		...
		/**
		 * add a HUD.js obj to the game manager
		 * @name me.game#addHUD
		 * @public
		 * @function
		 * @param {int} x x position of the HUD.js
		 * @param {int} y y position of the HUD.js
		 * @param {int} w width of the HUD.js
		 * @param {int} h height of the HUD.js
		...
		api.addHUD = function(x, y, w, h, bg) {
			// if no HUD.js existing
			if (api.HUD == null) {
				// create a new default HUD.js object
...
(function($) {
	...
	/************************************************************************************/
	/*      HUD.js FUNCTIONS :                                                             */
	/*      a basic HUD.js to be extended                                                  */
	/*                                                                                  */
	/************************************************************************************/

	/**
	 * Item skeleton for HUD.js element
	 * @class
	 * @extends Object
	 * @memberOf me
	 * @constructor
	 * @param {int} x x position (relative to the HUD.js position)
	 * @param {int} y y position (relative to the HUD.js position)
	 ...
	 * });
	 * 
	 * // add a default HUD.js to the game mngr (with no background)
	 * me.game.addHUD(0,0,480,100);
	 * // add the "score" HUD.js item
	 * me.game.HUD.js.addItem("score", new ScoreObject(470,10));
	 */
	 ...
	 * Object instance is accessible through me.game.HUD.js if previously initialized using me.game.addHUD(...);
	 * @class
	 * @extends Object
	 * @memberOf me
	 * @example
	...
	{	
		...
		init : function(x, y, w, h, bg) {
			...
			// state of HUD.js (to trigger redraw);
			...
			// this is a little hack to ensure the HUD.js is always the first draw
			this.z = 999;
			
			// ensure me.game.removeAll() will not remove the HUD.js
			this.isPersistent = true;

		},

		/**
		 * add an item to the me.game.HUD.js Object
		 * @name me.HUD_Object#addItem
		 * @public
		 * @function
		 * @param {String} name name of the item
		 * @param {me.HUD_Item} item HUD.js Item to be added
		 * @example
		 * // add a "score" HUD.js item
		 * me.game.HUD.js.addItem("score", new ScoreObject(470,10));
		 */
		...
		/**
		 * remove an item from the me.game.HUD.js Object
		 * @name me.HUD_Object#removeItem
		 * @public
		 * @function
		 * @param {String} name name of the item
		 * @example
		 * // remove the "score" HUD.js item
		 * me.game.HUD.js.removeItem("score");
		 */
		 ...
		 * me.game.HUD.js.setItemValue("score", 100);
		 */
		 ...
		 * me.game.HUD.js.updateItemValue("score", 10);
		 */
		 ...
		 * score = me.game.HUD.js.getItemValue("score");
		 */
		...
		/**
		 * return true if the HUD.js has been updated
		 * @private
		 */
		update : function() {
		 ...
		 * since the HUD.js if a flaoting object
		 * (is this correct?)
		 * @private
		 * @return {me.Rect} new rectangle
		 */
